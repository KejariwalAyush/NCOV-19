...
class _WorldState extends State<World> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLoading
          ? loadfailed
              ? Center(child: Text('Faild to load try after some time'))
              : Center(
                  child: Column(
          ...
          : SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //           TableRow(children: [
                  //             Text(
                  //               cList[i].toString().trim(),
                  //               textAlign: TextAlign.center,
                  //               style: TextStyle(
                  //                   color: Colors.black, fontSize: 16),
                  //             ),
                  //             Text(
                  //               casesList[i].toString().trim(),
                  //               textAlign: TextAlign.center,
                  //               style: TextStyle(
                  //                   color: Colors.blueAccent, fontSize: 16),
                  //             ),
                  //             Text(
                  //               deathList[i].toString().trim(),
                  //               textAlign: TextAlign.center,
                  //               style: TextStyle(
  ...
  fetchworld() async {
    ...
    if (response.statusCode == 200) {
      ...
      totcase = worlddata[4]['title'].toString().trim();
      detcase = worlddata[6]['title'].toString().trim();
      seriouscase = worlddata[8]['title'].toString().trim();
      curecase = worlddata[10]['title'].toString().trim();
      countries = worlddata[12]['title'].toString().trim();
